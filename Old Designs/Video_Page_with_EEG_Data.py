...
class VideoSyncApp(QWidget):
    ...
    def initUI(self):
        ...
        self.eeg_data_display.setFixedSize(800, 260)
        self.eeg_data_display.setStyleSheet("border: 2px solid black;")
        self.eeg_plot_layout = QVBoxLayout(self.eeg_data_display)
        ...
        self.upload_eeg_btn.clicked.connect(self.upload_eeg)
        ...
        eeg_data_panel.addWidget(self.eeg_data_display, alignment=Qt.AlignCenter)
    ...
    def upload_eeg(self):
        ...
        if file_name:
            self.process_and_plot_eeg(file_name)

    def process_and_plot_eeg(self, file_name):
        ...
        # axs[0].set_title("TP9", fontsize=8)
        axs[1].plot(df["timestamps"], df["AF7"], "tab:orange")
        # axs[1].set_title("AF7", fontsize=8, pad=20)
        axs[2].plot(df["timestamps"], df["TP10"], "tab:red")
        # axs[2].set_title("TP10", fontsize=8, pad=20)
        axs[3].plot(df["timestamps"], df["AF8"], "tab:green")
        # axs[3].set_title("AF8", fontsize=8, pad=20)
        ...
        self.eeg_plot_layout.addWidget(toolbar)
        self.eeg_plot_layout.addWidget(canvas)   
